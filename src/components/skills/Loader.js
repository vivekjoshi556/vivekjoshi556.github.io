...
const CppLoader = [
    ...
    {"type": "learning", "msg": "Threading - { This module is in build phase right now. }", "waitFor": "1000"},
    {"type": "status", "msg": "All the installed modules are currently in memory.", "waitFor": "1000"},
...
const PythonLoader = [
    ...
    {"type": "dependency", "msg": "Loading Concepts: Functions, Loops, Conditionals - { 30 mins }", "waitFor": "500"},
    {"type": "learning", "msg": "Learning Basic DS: List, Tuple, Dict, Sets - { 1:30 hrs }", "waitFor": "800"}
];
...
const GithubLoader = [
    ...
    {"type": "dependency", "msg": "Loading Basics of Git - { 30 mins }", "waitFor": "1000"},
    {"type": "learning", "msg": "Pull Requests", "waitFor": "1500"},
    {"type": "learning", "msg": "Merge Conflicts", "waitFor": "1000"},
    {"type": "learning", "msg": "Github Pages", "waitFor": "1500"},
    {"type": "link", "msg": "This skill is part of <a target = \"_blank\" href = \"https://google.com\" class = \"underline\"> SI Program</a>.", "waitFor": "500"}
...
const LaravelLoader = [
    ...
    {"type": "learning", "msg": "Databases: Migration, Seeding, & Pagination", "waitFor": "1000"},
    {"type": "learning", "msg": "Eloquent ORM - Models, CRUD, Soft & Hard Deletes, Mutators, Relationships, ...", "waitFor": "1000"},
    {"type": "learning", "msg": "Writing Middleware", "waitFor": "1000"},
    {"type": "learning", "msg": "Authentication & Authorization", "waitFor": "1000"},
    {"type": "status", "msg": "Core Archived. Required Modules Still In Cache.", "waitFor": "500"}
];
