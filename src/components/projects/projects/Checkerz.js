    ...
    return (
        <div>
            ...
            <p className = "pl-8 text-sm">
                The idea is to create a method that allows to validate Objects in Javascript. A method such that we don't have to repeat code that is used for validation at multiple places. Some of the rules (like type checking and others) are already provided by ORM's like Mongoose. But where they lack is if we need to conditional checks. 
            </p>
            <br/>
            ...
            <br />
            <img className = "w-full md:w-3/4 mx-auto border border-gray-100 shadow-xl rounded-xl" src = "/img/Projects/checkerz/homepage.png" alt = "" />
            <br/><br/>

            <div className = "flex justify-center items-center md:flex-row flex-col gap-4">
                <motion.a className = "duration-100 px-8 py-4 bg-[#cc3534D0] hover:bg-[#cc3534] text-lg rounded-full text-white"
                    href = "https://npmjs.org/package/checkerz" target = "_blank"
                    whileHover = {{ scale: 1.1 }}
                    transition = {{ type: "spring", stiffness: 1000, damping: 5 }}
                > 
                    Check Out Checkerz
                </motion.a>
                <motion.a className = "duration-100 px-8 py-4 bg-[#008000D0] hover:bg-[#008000] text-lg rounded-full text-white"
                    href = "https://github.com/vivekjoshi556/checkerz" target = "_blank"
                    whileHover = {{ scale: 1.1 }}
                    transition = {{ type: "spring", stiffness: 1000, damping: 5 }}
                > 
            ...
            <div className = "space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <div className = "bg-white p-8 rounded-xl border border-gray-50 shadow-xl">
                    ...
                    <p className = "text-gray-500 text-center dark:text-gray-400 text-sm">The package caters to different requirements by supporting both ES5 and ES6 syntax.</p>
                </div>
                <div className = "bg-white p-8 rounded-xl border border-gray-50 shadow-xl">
                    ...
                    <p className = "text-gray-500 text-center dark:text-gray-400 text-sm">This package prioritizes speed and efficiency for lightweight and fast validations.</p>
                </div>
                <div className = "bg-white p-8 rounded-xl border border-gray-50 shadow-xl">
                    ...
                    <p className = "text-gray-500 text-center dark:text-gray-400 text-sm">One-stop-shop export improves experience by bringing everything necessary to one place.</p>
                </div>
                <div className = "bg-white p-8 rounded-xl border border-gray-50 shadow-xl">
                    ...
                    <p className = "text-gray-500 text-center dark:text-gray-400 text-sm">The package undergoes continuous checks and updates to ensure its quality.</p>
                </div>
                <div className = "bg-white p-8 rounded-xl border border-gray-50 shadow-xl">
                    ...
                    <p className = "text-gray-500 text-center dark:text-gray-400 text-sm">Clear error messages simplify identification of issues by providing clarity.</p>
                </div>
            </div>
            <br/><br/>
