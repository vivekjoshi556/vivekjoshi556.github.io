export const projects = [
    {
        ...
        "description": "Service Provider applications where users could get any serivce they wanted, like plumbing, salon services, deliveries, laundry Service, Car Wash and many others. At the same time provides could provide these services and earn money.",
        "tags": ["Laravel", "Tailwind CSS", "Livewire", "Google Maps API", "Stripe Payment Gateway"],
        "img": "/img/Projects/service/1.png",
    ...
    },
    {
        ...
        "img": "/img/Projects/musicGenre/music_genre_classification.jpg",
